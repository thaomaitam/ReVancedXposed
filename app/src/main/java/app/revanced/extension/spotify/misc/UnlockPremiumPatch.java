...
public final class UnlockPremiumPatch {
     ...
     */
    public static boolean IS_SPOTIFY_LEGACY_APP_TARGET;
     ...
     */
    public static void removeHomeSections(List<Object> sections) {
        try {
            sections.removeIf(section -> REMOVED_HOME_SECTIONS.contains(XposedHelpers.getIntField(section, "featureTypeCase_")));
        } catch (Exception ex) {
